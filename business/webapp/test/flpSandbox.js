		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "business",
									"targetURL": "#app04business-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"app04business-display": {
								"semanticObject": "app04business",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app04.business",
									"url": sap.ui.require.toUrl("app04/business")
								}
							}
						}
					}
